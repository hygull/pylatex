...
"""
It asked for downloading some files while running
"""

"""
rishikesh agrawani@DESKTOP-8AATOO4 MINGW64 /d/projects/Python/PyLaTex/13_own_commands_example (master)
$ ls
own_commands_example.py

rishikesh agrawani@DESKTOP-8AATOO4 MINGW64 /d/projects/Python/PyLaTex/13_own_commands_example (master)
$ python own_commands_example.py

rishikesh agrawani@DESKTOP-8AATOO4 MINGW64 /d/projects/Python/PyLaTex/13_own_commands_example (master)
$ ls
own_commands_ex.pdf  own_commands_ex.tex  own_commands_example.py
